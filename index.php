...
//////////////  DEBUT DU ROUND /////////////////////////////
    while($round <= 10){                                       ////// Tant que le 10eme round n'est pas terminé : 
        echo '<p style="color:red">Round N°'.$round.' : </p>'; // Indique à quel round nous sommes
...
/////////////   SI LE LANCE A FAIT STRIKE ///////////////////
        if($premiere_boule == $gg){                            ////// Si le 1er lancé est directement un STRIKE : 
            ...
            echo '<h3 style="color:blue">STRIKE ! 10 points ! '.' '.'Score total : </h3>'.$cumul; // Annonce le strike
...
//////////// SI LE LANCE NE FAIT PAS STRIKE    /////////////
            ...
            echo 'Resultat du lancé N° '.$boule.' : '.$premiere_boule.'</br></br>'; // Annonce le résultat du 2eme lancé
...
////////////    SI LES LANCES ONT FAIT SPARE    /////////////////
            if($resultat+$premiere_boule == 10){               ////// Si toutes les quilles sont tombé aprés le 2eme lancé :
                ...
                echo '<h3 style="color:green">Spare ! 10 points ! '.' '.' Score total : </h3>'.$cumul; // Annonce le SPARE et le score total
...
//////////// SI IL RESTE DES QUILLES APRES 2 LANCES /////////
                ...
                echo $resultat+$premiere_boule.' Score total : '.$cumul; // Annonce le score cumulé des deux lancé, et le score total
